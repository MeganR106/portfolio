...
import { myGithub, projects, myGitlab } from "../constants"
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        >
          Want to see more? You can find more projects at my GitHub and GitLab at the
          links below.
        </motion.p>
        ...
        < div className="green-pink-gradient p-[1px] rounded-full flex justify-center items-center cursor-pointer mt-4"
          onClick={() => window.open(myGitlab, "_blank")}
        >
          <div className="bg-tertiary rounded-full px-3 py-2 flex justify-evenly items-center">
            <img
              src={gitlab}
            ...
            <p className="text-[21px]">GitLab</p>
          </div>
        </div>
      </div>
    </>
